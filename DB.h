...
public:
	...
	bool InscriereScore(string username, string denumire_joc, string score);
	string getallFriends(string host);
	string denumireJoc(string denumire);
	string topScore(string denumire_joc);
	string allTopsScore();
	string chat();
	string pathJoc(string denumire);
	string pathImage(string denumire);
	bool SchimbaParola(string username, string nouaparola);
	string getDenumiriJoc();
	bool addJoc(string denumire, string descriere, string path);
	string InsertChat(string username, string mesaj);
	bool logoutUser(string log);
